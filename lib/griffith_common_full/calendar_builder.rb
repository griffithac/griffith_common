module GriffithCommonFull
  module CalendarBuilder
    ...
    class CalendarBuilder < TableBuilder::TableBuilder
    ...
    class Calendar
      ...
      def objects_for_days(objects, day_method)
        unless @objects_for_days
          ...
          objects.each do |o|
            date = o.send(day_method.to_sym).to_date.strftime("%Y-%m-%d") ## added to_date to covert to date if already string - ACG
