                ...
                case 'modal':
                    template = '<div class="bootstrap-timepicker modal hide fade in" style="top: 30%; margin-top: 0; width: 200px; margin-left: -100px;" data-backdrop="false">'+
                                   ...
                                   '<div class="modal-content">'+
                                       '<table>'+
                                           '<tr>'+
                                               '<td><a href="#" data-action="incrementHour" class="btn btn-default"><i class="fa fa-chevron-up"></i></a></td>'+
                                               '<td class="separator"></td>'+
                                               '<td><a href="#" data-action="incrementMinute" class="btn btn-default"><i class="fa fa-chevron-up"></i></a></td>'+
                                               ( this.showMeridian ? '<td><a href="#" data-action="toggleMeridian" class="btn btn-default"><i class="fa fa-chevron-up"></i></a></td>' : '' ) +
                                           '</tr>'+
                                           '<tr>'+
                                           ...
                                           '</tr>'+
                                           '<tr>'+
                                               '<td><a href="#" data-action="decrementHour" class="btn btn-default"><i class="fa fa-chevron-down"></i></a></td>'+
                                               '<td class="separator"></td>'+
                                               '<td><a href="#" data-action="decrementMinute" class="btn btn-default"><i class="fa fa-chevron-down"></i></a></td>'+
                                               ( this.showMeridian ? '<td><a href="#" data-action="toggleMeridian" class="btn btn-default"><i class="fa fa-chevron-down"></i></a></td>' : '' ) +
                                           '</tr>'+
                                       '</table>'+
                                   '</div>'+
